...
class TestTradingCalendar:
    ...
    def test_is_trading_day_weekday(self, calendar):
        ...
        # Monday Jan 13, 2020 (after New Year holidays)
        assert calendar.is_trading_day("2020-01-13") is True
        # Monday Jan 20, 2020
        assert calendar.is_trading_day("2020-01-20") is True
    ...
    def test_prev_trading_day(self, calendar):
        ...
        # From Monday Jan 13, previous trading day should be Friday Jan 10
        prev_day = calendar.prev_trading_day("2020-01-13")
